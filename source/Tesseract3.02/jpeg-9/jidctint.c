		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < DCTSIZE; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    z2 = (int) wsptr[0] + (ONE << (PASS1_BITS+2));
    z3 = (int) wsptr[4];
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 7; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp13 = (int) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp13 <<= CONST_BITS;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 6; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp0 = (int) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp0 <<= CONST_BITS;
    tmp2 = (int) wsptr[4];
    tmp10 = MULTIPLY(tmp2, FIX(0.707106781));   /* c4 */
    tmp1 = tmp0 + tmp10;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 5; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp12 = (int) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp12 <<= CONST_BITS;
    tmp0 = (int) wsptr[2];
    tmp1 = (int) wsptr[4];
    z1 = MULTIPLY(tmp0 + tmp1, FIX(0.790569415)); /* (c2+c4)/2 */
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 10; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    z3 = (int) wsptr[0] + (ONE << (PASS1_BITS+2));
    z3 <<= CONST_BITS;
    z4 = (int) wsptr[4];
    z1 = MULTIPLY(z4, FIX(1.144122806));         /* c4 */
    z2 = MULTIPLY(z4, FIX(0.437016024));         /* c8 */
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 11; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp10 = (int) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp10 <<= CONST_BITS;
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 13; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    z1 = (int) wsptr[0] + (ONE << (PASS1_BITS+2));
    z1 <<= CONST_BITS;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 14; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp23 = (int) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp23 <<= CONST_BITS;
