...
static const TIFFField ojpegFields[] = {
	...
	{TIFFTAG_JPEGPROC,1,1,TIFF_SHORT,0,TIFF_SETGET_U__int16,TIFF_SETGET_UNDEFINED,FIELD_OJPEG_JPEGPROC,FALSE,FALSE,"JpegProc",NULL},
	{TIFFTAG_JPEGRESTARTINTERVAL,1,1,TIFF_SHORT,0,TIFF_SETGET_U__int16,TIFF_SETGET_UNDEFINED,FIELD_OJPEG_JPEGRESTARTINTERVAL,FALSE,FALSE,"JpegRestartInterval",NULL},
};
...
/*
  Libjpeg's jmorecfg.h defines __int16 and int, but only if XMD_H is
  not defined.  Unfortunately, the MinGW and Borland compilers include
  a typedef for int, which causes a conflict.  MSVC does not include
